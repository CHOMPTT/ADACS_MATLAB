...
tsim = t(i);
    for j = 1:4
        ...
        Fd_s = R_s_i * Fd(:,i2);%Disturbance force expressed in S/C ref. frame
        ...
        %RK4 Integrator
        if j == 1
            k1 = CHOMPTT_EOM(state, Tc, Fd, Td, w_i_e, R_s_i);     
        elseif j == 2
            k2 = CHOMPTT_EOM(state + t_step*k1/2, Tc, Fd, Td, w_i_e, R_s_i); 
        elseif j == 3
            k3 = CHOMPTT_EOM(state + t_step*k2/2, Tc, Fd, Td, w_i_e, R_s_i); 
        elseif j == 4
            k4 = CHOMPTT_EOM(state + t_step*k3  , Tc, Fd, Td, w_i_e, R_s_i);  
        end 
    end 
